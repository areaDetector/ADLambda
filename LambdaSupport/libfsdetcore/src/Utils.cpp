...
namespace FSDetCoreNS
{
    ...
    /// StringUtils
    //////////////////////////////////////////////////
    void StringUtils::StrSplit(const string strOriginal,
    ...
    void StringUtils::FindAndReplace(string& strSrc,
    ...
    /// DataConvert
    //////////////////////////////////////////////////
    void DataConvert::IntToUChar(int32 nVal, vector<uint8>& vUChar)
    {
        LOG_TRACE(__FUNCTION__);

        vUChar[0] = (nVal >> 24 & 0xFF);
        vUChar[1] = (nVal >> 16 & 0xFF);
        vUChar[2] = (nVal >> 8 & 0xFF);
        vUChar[3] = (nVal & 0xFF);
    }
