...
namespace FSDetCoreNS
{
    ...
    ThreadPool::ThreadPool(int32 _nThreadNumber)
        ...
        , m_enumCurrentPriority(NORMAL)
    {
        ...
        for(int32 i = 0; i < m_nThreadNumber; i++)
    ...
    int32 ThreadPool::GetAvailableThreads()
    {
        boost::unique_lock<boost::mutex> lock(m_boostMtx);
