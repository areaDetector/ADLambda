...
namespace DetLambdaNS
{
    ...
    class LambdaSysImpl : public LambdaInterface
    {
      public:
        ...
        LambdaSysImpl(string _strConfigPath, Enum_log_level _level = ERROR);
        ...
        void SetCompressionMethod(int32 nMethod,int32 nCompLevel = 2);
      ...
      protected:
        ...
        uptr_module m_objModuleCtrl;
        uptr_datarecv m_objDataRecv;
